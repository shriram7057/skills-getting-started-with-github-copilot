...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming practice and water fitness activities",
    ...
    "Drama Club": {
        "description": "Participate in acting, stage plays, and performances",
    ...
    "Science Club": {
        "description": "Perform science experiments and attend STEM events",
